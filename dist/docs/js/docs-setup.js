NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$rootscope $scope accepts action actioncallback actionfn actions actions-label actiontext actiontitle allowed angular api btn btn-default btn-group button buttons caret checkbox class click close close-callback closecallback closed closes col-md-12 col-sm-1 col-sm-10 col-sm-12 col-sm-2 col-sm-3 component content control-label controller current danger data default directive disable disabled display displayed displayes dropdown-menu-right example-container false flag form-control form-group form-horizontal function grouped handleaction handleclose header html info invoke isdisabled ispersistent isseparator item js kebab list list-style-type main menu menuaction menuactions menuitem message module ng-class ng-click ng-controller ng-model ng-repeat notification notifications notify object optional patternfly perform performaction persistent pftoastnotification place placehodler primary primaryaction remove role row rows script selected separator set setviewing show-close showclose showmenu style success tabindex text times title toast toastnotificationlistdemoctrl true type typemap types uib-dropdown uib-dropdown-menu uib-dropdown-toggle unavailable undefined update-viewing updatetype updateviewing user var viewing warning"
    },
    {
      "section": "api",

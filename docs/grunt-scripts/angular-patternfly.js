...
;angular.module('patternfly.charts').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('charts/utilization-donut/utilization-donut-chart.html',
    "<span class=utilization-donut-chart-pf ng-class=\"{'data-unavailable-pf': $ctrl.chartData.dataAvailable === false}\"><span ng-if=\"!$ctrl.layout || $ctrl.layout.type === 'regular'\">REGULAR<pf-donut-pct-chart config=$ctrl.custConfig data=$ctrl.chartData center-label=$ctrl.chartLabel></pf-donut-pct-chart><label>center-label = ' none'</label></span> <span ng-if=\"$ctrl.layout && $ctrl.layout.type === 'inline'\">INLINE<pf-donut-pct-chart config=$ctrl.custConfig data=$ctrl.chartData center-label=$ctrl.chartLabel></pf-donut-pct-chart><label>Label Goes Here</label></span><!--<div class=\"utilization-bar-chart-pf\"  ng-class=\"{'data-unavailable-pf': $ctrl.chartData.dataAvailable === false}\">\n" +
